...
date: 2026-02-05T10:25:46+05:30
topics:
- Cryptography
- Cryptanalysis
- Number Theory
...
>**Non-uniformly Strongly One Way Functions:** A function $f(x)$ is non-uniformly strongly one way iff $\exists p(n) \in P$ such that $f(x)$ is $\mathcal{O}(p(n))$ and $$\forall \{C_n\}n\in\mathbb{N} Pr\bigg[C_n[f(x)]=x'\,|f(x')=f(x) \bigg]<\frac{1}{p(n)}\,\,\, \forall \forall p(n)\in \mathcal{P}, \forall n\geq N, N\in\mathbb{N}$$ 
